        ...
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        <h3 class="text-xl font-bold">Sanggar Tari</h3>
                        <p class="text-sm text-gray-400">Kembang Sore</p>
                    </div>
                </div>
                <p class="text-gray-400 text-sm leading-relaxed">
                    Melestarikan budaya tari tradisional Indonesia dengan pembelajaran berkualitas dan fasilitas terbaik.
                </p>
            </div>

            <!-- Quick Links -->
            <div>
                <h4 class="text-lg font-semibold mb-4 text-red-400">Tautan Cepat</h4>
                <ul class="space-y-2">
                    <li>
                        <a href="#" class="text-gray-400 hover:text-white transition duration-300">Beranda</a>
                    </li>
                    <li>
                        <a href="#tentang" class="text-gray-400 hover:text-white transition duration-300">Tentang Kami</a>
                    </li>
                    <li>
            ...
            <!-- Layanan -->
            <div>
                <h4 class="text-lg font-semibold mb-4 text-green-400">Layanan Kami</h4>
                <ul class="space-y-2">
            ...
            <!-- Contact -->
            <div>
                <h4 class="text-lg font-semibold mb-4 text-red-400">Hubungi Kami</h4>
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-gray-400 text-sm">Gogorante, Kec. Ngasem, Kabupaten Kediri, Jawa Timur 64182</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        <svg class="w-5 h-5 text-green-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <a href="https://wa.me/6285113660105" target="_blank" class="text-gray-400 text-sm hover:text-green-500 transition-colors">
                            +62 851-1366-0105
                        </a>
                    </li>
                    <li class="flex items-center space-x-3">
                        ...
                        <span class="text-gray-400 text-sm">info@kembangsore.id</span>
                    </li>
                </ul>
        ...
        <div class="border-t border-gray-800 pt-8 mt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm mb-4 md:mb-0">
                    &copy; {{ date('Y') }} Sanggar Tari Kembang Sore. Hak Cipta Dilindungi.
                </p>
